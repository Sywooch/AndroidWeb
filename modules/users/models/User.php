...
class User extends ActiveRecord implements IdentityInterface
{
    ...
    public function rules()
    {
        return [
			...
			[['first_name', 'last_name', 'mobile', 'email', 'status'], 'required'],
			[['first_name', 'last_name', 'mobile', 'email', 'status'], 'trim'],
			[['first_name', 'last_name'], 'string', 'max' => 45],
			[['garage_owner_name','customer_name'],'string','max'=>100],
			['mobile', 'string', 'min' => 10],
            ['mobile', 'unique', 'targetClass' => self::className(), 'message' => 'This mobile number has already been taken.'],

            [['role', 'registration_type', 'type'], 'safe'],
        ];
    }
    ...
    public function attributeLabels()
    {
        return [
			...
			'islogged' => Module::t('module', 'Logged Status'),
            'username' => Module::t('module', 'Username'),
            'garage_owner_name'=> Module::t('module', 'Garage Owner Name'),
            'customer_name'=> Module::t('module', 'Customer Name'),
            'email' => Module::t('module', 'Email'),
			'mobile' => Module::t('module', 'Mobile Number'),
    ...
    public function findNamebyId($u_id){
        $name = self::find()
