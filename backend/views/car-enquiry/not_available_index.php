    ...
    $gridColumn = [
       ...
       // 'user_id',
        ...
        [
            ...
            'template'=>'{move}   {view}   {delete}',
            'buttons'=>[
                'move' => function ($url, $model) {     
                return Html::a('<i class="fa fa-undo" aria-hidden="true"></i>', ['car-enquiry/move-pending-enquiry?id='.$model->id],['data-confirm' => 'Are you want to move this to the Pending Enquiry?','data-method' => 'post']);  
                }
            ],
        ],
    ]; 
