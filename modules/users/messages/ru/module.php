...
return [
    ...
    'Enter your current password.' => 'Укажите текущий пароль.',
    ...
    'Email confirm token cannot be blank.' => 'Токен подтверждения электронной почты, не может быть пустым!',
    ...
    'The message was successfully sent!' => 'Сообщение успешно отправленно!',
    ...
    'Enter your email address' => 'Укажите адрес электронной почты',
