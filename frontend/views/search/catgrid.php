...
?>	
									...
									<div class="filter-options-item filter-options-categori">
										...
										<div class="filter-options-content">
											...
											<?= $form->field($model1, 'name')->label('Brand')->dropDownList(ArrayHelper::map(CarInfo::find()->select(['ci_id','name'])->where(['type'=>1])->all(), 'ci_id', 'name'), ['id'=>'cat-id','prompt'=>'Select Brand',
												...
												$('#ajaxchange').load(url,{page_size:page_size,sort_type:sort_type,end_slug,brnd_select:brnd_select,car_info_brand:brand_id});
												"
											]);
											?>
												    ...
												    'pluginOptions'=>[
												     ...
												     'pluginEvents' => [
													    "select2:select" => "function() {
															...
															var sort_type = $('#sort_type option:selected').val();
															var sort_type_name = $('#sort_type option:selected').text();
															$('#ajaxchange').load(url,{page_size:page_size,sort_type:sort_type,end_slug,brnd_select:brnd_select,brand_id:brand_id,model_id:model_id});
													    }",
													],
												]);
											?>
												...
												'type'=>DepDrop::TYPE_SELECT2,
												    ...
												    'pluginOptions'=>[
													    ...
													    "select2:select" => "function() {
															...
															var sort_type = $('#sort_type option:selected').val();
															var sort_type_name = $('#sort_type option:selected').text();
															$('#ajaxchange').load(url,{page_size:page_size,sort_type:sort_type,end_slug,brnd_select:brnd_select,brand_id:brand_id,model_id:model_id,variant_id:variant_id});
													    }",
													],
												]);
											?>
												...
												'type'=>DepDrop::TYPE_SELECT2,
												    ...
												    'pluginOptions'=>[
													    ...
													    "select2:select" => "function() {
															...
															var sort_type = $('#sort_type option:selected').val();
															var sort_type_name = $('#sort_type option:selected').text();
															$('#ajaxchange').load(url,{page_size:page_size,sort_type:sort_type,end_slug,brnd_select:brnd_select,brand_id:brand_id,model_id:model_id,variant_id:variant_id,fuel_id:fuel_id});
													    }",
													],
												]);
											?>
												    ...
												    'pluginOptions'=>[
												       ...
												       'pluginEvents' => [
													    "select2:select" => "function() {
															...
															var sort_type = $('#sort_type option:selected').val();
															var sort_type_name = $('#sort_type option:selected').text();
															$('#ajaxchange').load(url,{page_size:page_size,sort_type:sort_type,end_slug,brnd_select:brnd_select,brand_id:brand_id,model_id:model_id,variant_id:variant_id,fuel_id:fuel_id,year_id:year_id});
													    }",
													],
												]);
											?>
	...
	<input type="hidden" id="xx" value="<?php echo Url::toRoute(['search/sort-by'])?>">
	<input type="hidden" id="xx1" value="<?php echo $end_slug1;?>">
...
$(document).ready(function(){
	...
	function filter(){
		...
		var sort_type_name = $("#sort_type option:selected").text();
			...
			$("#ajaxchange").load(url,{page_size:page_size,sort_type:sort_type,end_slug,brnd_select:brnd_select});
	}
