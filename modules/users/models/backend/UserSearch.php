...
class UserSearch extends User
{
    ...
    public function rules()
    {
        return [
            ...
            [['first_name', 'last_name', 'username', 'email', 'mobile', 'avatar', 'role', 'userRoleName', 'date_from', 'date_to', 'fullName'], 'safe'],
        ];
    }
    ...
    public function search($params)
    {
        ...
        $query->leftJoin('{{%auth_assignment}}', '{{%auth_assignment}}.user_id = {{%user}}.id')->where(['like', '{{%auth_assignment}}.item_name', 'user']);
