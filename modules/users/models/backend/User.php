...
class User extends \modules\users\models\User
{
    ...
    public function rules()
    {
        return ArrayHelper::merge(parent::rules(), [
			...
			[['newPassword', 'newPasswordRepeat'], 'trim'],
        ]);
    }
    ...
    public function scenarios()
    {
        ...
        $scenarios[self::SCENARIO_ADMIN_CREATE] = ['avatar', 'username', 'mobile', 'email', 'status', 'role', 'newPassword', 'newPasswordRepeat', 'registration_type', 'first_name', 'last_name'];
        $scenarios[self::SCENARIO_ADMIN_UPDATE] = ['username', 'email', 'mobile', 'status', 'role', 'first_name', 'last_name'];
